...
def create_training_data(SPEC):
    ...
    if SPEC == "linear":
        ...
        data_train = np.load("../coch_data/coch_train2.npz")
        data_test = np.load("../coch_data/coch_test2.npz")
    ...
    for params in param_sets:
        ...
        for fold, (train_idx, test_idx) in enumerate(kf.split(X)):
            ...
            for i in range(iterations):
                ...
                model = DeepNetwork(n_reservoirs=6, N_total=N, sr=sr, lr=lr, sigma=sigma, ridge=1e-7,
